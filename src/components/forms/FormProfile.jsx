...
const FormProfile = () => {
    ...
    return (
        <Form>
            ...
            <div className="row">
                <div className="col-6">
                    <label htmlFor="nama" className="form-label mt-3 d-flex"><strong>Nama</strong></label>
                    <input type="text" name="nama" id="id" className="form-control" value={"Konn"} disabled={!isEditMode} />
                </div>
                <div className="col-6">
                    <label htmlFor="email" className="form-label mt-3 d-flex"><strong>Email</strong></label>
